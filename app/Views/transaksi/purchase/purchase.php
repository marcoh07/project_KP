...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <form class="col float-right" action="<?php echo base_url(); ?>/PurchaseController/insertPurchase" method="post">
                    <button class="btn btn-secondary float-right" type="submit"><i class="fa fa-plus"></i> Add New</button>
                </form>
                <div class="col-md-8 offset-md-2">
                    <form action="<?php echo base_url(); ?>/PurchaseController/search">
