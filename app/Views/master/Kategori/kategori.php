                        ...
                        if (count($data)>0)
                        {
                            foreach ($data as $key=>$value)
                            {
                                echo "<tr>";
                                    ...
                                    echo "<td><button class='btn btn-default'>Lihat</button></td>";    
                                    echo "<td><button class='btn btn-default'>Edit</button></td>";    
                                    echo "<td><button type='button' class='btn btn-default' data-toggle='modal' data-target='#modal-default'>Delete</button></td>";    
                                echo "</tr>";    
                            }
                        }
                    ?>
